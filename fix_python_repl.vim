...
if !exists("g:neoterm_python_version")
   let g:neoterm_python_version = 'python2'
endif

" TODO wrap in function and enumerate all python defaults and set var for
" desired REPL
if !exists("g:neoterm_python_repl")
   if g:neoterm_python_version ==# 'python2'
